...
public class AnnouncementServiceTest extends BaseExoTestCase {
  ...
  public void setUp() { // NOSONAR
    ...
    getContainer().unregisterComponent(SpaceService.class);
    getContainer().unregisterComponent(IdentityManager.class);
    getContainer().registerComponentInstance("org.exoplatform.social.core.space.spi.SpaceService", spaceService);
    getContainer().registerComponentInstance("org.exoplatform.social.core.manager.IdentityManager", identityManager);
    ConversationState.setCurrent(new ConversationState(new org.exoplatform.services.security.Identity("root", Collections.emptyList())));
  ...
  public void testCreateAnnouncement() throws IllegalAccessException, ObjectNotFoundException {
    ...
    assignee.add(1L);
    Announcement announcement = new Announcement(0, challenge.getId(),assignee, "announcement comment", 1L,  new Date(System.currentTimeMillis()).toString(), null);
    Announcement createdAnnouncement = new Announcement(1, challenge.getId(),new ArrayList<>(1), "announcement comment", 1L,  new Date(System.currentTimeMillis()).toString(), null);
  ...
  public void testUpdateAnnouncement() throws IllegalAccessException, ObjectNotFoundException {
    ...
    Announcement announcement = new Announcement(0, challenge.getId(),assignee, "announcement comment", 1L,  new Date(System.currentTimeMillis()).toString(), null);
    Announcement createdAnnouncement = new Announcement(1, challenge.getId(),new ArrayList<>(1), "announcement comment", 1L,  new Date(System.currentTimeMillis()).toString(), null);
    Announcement editedAnnouncement = new Announcement(1, challenge.getId(),new ArrayList<>(1), "announcement comment", 1L,  new Date(System.currentTimeMillis()).toString(), 1L);
    Identity spaceIdentity = new Identity();
    spaceIdentity.setId("1");
    spaceIdentity.setProviderId("space");
    spaceIdentity.setRemoteId("test_space");
  ...
  public void testGetAnnouncementByChallenge() throws IllegalAccessException, ObjectNotFoundException {
    ...
    List<Long> assignee = new ArrayList<Long>();
    assignee.add(1L);
    Announcement announcement1 = new Announcement(0, challenge.getId(),assignee, "announcement comment", 1L,  new Date(System.currentTimeMillis()).toString(), null);
    Announcement announcement2 = new Announcement(1, challenge.getId(),new ArrayList<>(1), "announcement comment", 1L,  new Date(System.currentTimeMillis()).toString(), null);
    Announcement announcement3 = new Announcement(1, challenge.getId(),new ArrayList<>(1), "announcement comment", 1L,  new Date(System.currentTimeMillis()).toString(), 1L);
